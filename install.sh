...
#Installing a few packages
	apt install -y openssh-server mysql-client wget curl nano unzip sed file libncurses5-dev libncursesw5-dev libssl-dev libpam0g-dev zlib1g-dev dh-autoreconf software-properties-common proftpd screen php htop build-essential make cmake scons make gcc g++ pkg-config
